...
export const AboutHero = () => {
    ...
    const findHemoHero = () => {
        axios.get(`${API.BASE_URL}home/allbanner`, {
            headers: {
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="col-sm-8">
                                                ...
                                                >
                                                    ...
                                                    <option value={"AboutHero"}>About Hero</option>
                                                    <option value={"AboutUs"}>About Us</option>
                                                    <option value={"Servicesmain"} >Service Hero Main</option>
                                                    <option value={"Servicessub"} >Service Hero Sub</option>
